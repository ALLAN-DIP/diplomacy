...
export class ContentGame extends React.Component {
    ...
    onChangeOrderDistribution(requestedPower, requestedProvince){
        ...
        console.debug(`Found relevant messages ${provinceOrderDistributions}`);
        ...
        if (!this.state.displayVisualAdvice){
            this.setState({ orderDistribution: [ { power: requestedPower, distribution: provinceOrderDistribution.predicted_orders, province: requestedProvince } ] }); 
        }
        else{
