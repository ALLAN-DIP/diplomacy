...
This project contains an open-source DATC-compliant Diplomacy game engine, a client-server architecture for network play, and a web interface to play against bots and to visualize games.
